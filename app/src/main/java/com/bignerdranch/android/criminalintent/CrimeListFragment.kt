                ...
                crimeListViewModel.crimes.collect { crimes ->
                    binding.crimeRecyclerView.adapter =
                        CrimeListAdapter(crimes,
                            ...
                            onSwipeToDelete = { crimeId ->
                                Log.d(TAG, "crimeId = $crimeId")
                            }
                        )

//                    val swipeDelete = object: SwipeToDeleteCallback(this) {
                // Activity용인가봄. this@MainActivity 대신, this@Framgent이름 안 먹음
//                        // this@lauch  ?? or
//                        // this@CrimeListFragment ??
//                        override fun onSwiped(
//                            viewHolder: RecyclerView.ViewHolder,
//                            direction: Int
//                        ) {
////                            binding.crimeRecyclerView.adapter.deleteItem(viewHolder, viewHolder.itemId)
//                            Log.d(TAG, "onSwipe : viewOlder.itemId = ${viewHolder.itemId}")
//                        }
//                    }
//
